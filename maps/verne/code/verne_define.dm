/datum/map/verne
	...
	empty_levels = list(6)
	accessible_z_levels = list("1"=1,"2"=1,"3"=1,"6"=25)
	overmap_size = 40
	overmap_event_areas = 34
	allowed_spawns = list("Cryogenic Storage", "Cyborg Storage")
	default_spawn = "Cryogenic Storage"

	station_name  = "SRV Verne"
	station_short = "Verne"
	company_name  = "Cetite Technical Institute"
	company_short = "CTI"
	...
	away_site_budget = 9 // Авейки это наша жизнь
