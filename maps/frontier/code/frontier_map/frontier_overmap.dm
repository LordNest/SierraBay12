/obj/overmap/visitable/ship/sierra
	name = "Asteroid Base"
	desc = "A large asteroid with a number of man-made structures on its surface and within the rock. The transponder indicates that it is a logistics hub. The encryption codes were used by the Terran Commonwealth.."
	fore_dir = WEST
	vessel_mass = 63000
	sector_flags = OVERMAP_SECTOR_KNOWN|OVERMAP_SECTOR_IN_SPACE|OVERMAP_SECTOR_BASE
	known_ships = list(/obj/overmap/visitable/ship/landable/guppy)
