...
/atom/movable/screen/navigate_arrow/proc/start_effect(turf/tracked_turf, arrow_color)
	...
	color = arrow_color
	addtimer(new Callback(src, PROC_REF(end_effect)), 1.6 SECONDS)
