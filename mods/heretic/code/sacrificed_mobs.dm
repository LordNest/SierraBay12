...
/datum/sacrificed_mobs/New(newName, newDNA, newSpecies, newLanguages, newGender , newPronouns, list/newFlavour, list/New_icon_render_keys, list/newBuild)
	..()
	name = newName
	dna = newDNA
