...
/datum/antagonist/heretic
	...
	welcome_text = "Вы давно знаете, что мир не так прост. За пеленой скрываются великие силы, которые можно использовать чтобы вырваться из вечного цикла. Сделайте это."
	victory_text = "Еретик вознёсся, обратив корабль в сцены хтонического ужаса"
 ...
 * Вероятно стоит удалить, потому что это не наше дело, мы тут ролеплеим
 */
